...
class DisplayCmdResponser : public V1_4::DisplayCmdResponser<Transfer, VdiImpl> {
public:
    ...
    DisplayCmdResponser(VdiImpl* impl, std::shared_ptr<DeviceCacheManager> cacheMgr) : BaseType1_4(impl, cacheMgr) {}

    virtual ~DisplayCmdResponser() {}

private:
    using BaseType1_4 = V1_4::DisplayCmdResponser<Transfer, VdiImpl>;
};
