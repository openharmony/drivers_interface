...
static uint32_t g_ohosCameraSectionBounds[OHOS_SECTION_COUNT][2] = {
    ...
    [OHOS_SECTION_CAMERA_SECURE] = {OHOS_CAMERA_SECURE_CONTROL_START, OHOS_CAMERA_SECURE_CONTROL_END },
};
...
static item_info_t g_ohosCameraSecure[OHOS_CAMERA_SECURE_CONTROL_END - OHOS_CAMERA_SECURE_CONTROL_START] = {
    [OHOS_CONTROL_SECURE_FACE_MODE -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"secureFaceMode", META_TYPE_INT32, 1},
    [OHOS_CONTROL_SECURE_FACE_INFO -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"secureFaceInfo", META_TYPE_INT32, -1},
    [OHOS_CONTROL_SECURE_FACE_AUTH_RESULT -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"faceAuthResult", META_TYPE_INT32, 1},
    [OHOS_CONTROL_SECURE_FLASH_SEQ -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"secureFlashSeq", META_TYPE_INT32, -1},
    [OHOS_CONTROL_SECURE_IR_LED_SWITCH -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"irLedSwitch", META_TYPE_BYTE, 1},
    [OHOS_CONTROL_SECURE_IR_LOCKAE_SWITCH -
        OHOS_CAMERA_SECURE_CONTROL_START] = {"irLockaeSwitch", META_TYPE_BYTE, 1},
};
