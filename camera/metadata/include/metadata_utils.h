...
public:
    ...
    static void ReadCameraMetadata(MessageParcel &data, common_metadata_header_t *meta, uint32_t tagCount);
    static bool WriteCameraMetadata(const common_metadata_header_t* meta, MessageParcel &data);
