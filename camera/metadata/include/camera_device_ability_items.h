...
typedef enum camera_focus_assist_flash_mode_enum {
    OHOS_CAMERA_FOCUS_ASSIT_FLASH_MODE_DEFAULT = 0,
    OHOS_CAMERA_FOCUS_ASSIT_FLASH_MODE_AUTO,
    OHOS_CAMERA_FOCUS_ASSIT_FLASH_MODE_ON,
    OHOS_CAMERA_FOCUS_ASSIT_FLASH_MODE_OFF
