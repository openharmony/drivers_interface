...
typedef enum camera_device_metadata_tag {
     ...
     * 
     * camera property, current camera supported/nosupported
     * (i.e. enum camera device supported frame)
     */
    OHOS_ABILITY_CAMERA_MACRO_SUPPORTED,
    /**
     * ohos.ability.camera [static, byte, ndk_public]
     * 
     * camera property, current camera disbale/enable
     * (i.e. byte camera device supported frame)
     */
    OHOS_CAMERA_MACRO_STATUS,
    /**
     * ohos.control.camera [static, byte, ndk_public]
     * 
     * camera property, current camera disbale/enable
     * (i.e. byte camera device supported frame)
     */
     ...
     * 
     * camera property, current camera virtual aperture range
     ...
     * 
     * camera property, current camera virtual aperture value
     * (i.e. float camera device supported frame)
     */
     ...
     * ohos.control.camera [static, float[], ndk_public]
     * 
     * camera property, current camera physical aprtture range
     * (i.e. float[] camera device supported frame)
     */
     ...
     * ohos.control.camera [static, float, ndk_public]
     * 
     * camera property, current camera physical aprtture value
     * (i.e. float camera device supported frame)
     */
     ...
     * 
     * camera property, current camera aprtture value
     * (i.e. float camera device supported frame)
     */
     ...
     * 
     * camera property, current camera exitcamera event
     ...
     * 
     * camera property, current camera phone screen ratio
     ...
     * 
     * camera property, current camera disable/ready/start/recording/finish
     * (i.e. enum camera device supported frame)
     */
    OHOS_STATUS_SLOW_MOTION_DETECTION,
    /**
     * ohos.ability.motion [static, byte, ndk_public]
     * 
     * camera property, current camera support/nosupport
     * (i.e. byte camera device supported frame)
     */
    OHOS_ABILITY_MOTION_DETECTION_SUPPORT,
    /**
     * ohos.control.motion [static, byte, ndk_public]
     * 
     * camera property, current camera disable/enable
     * (i.e. byte camera device supported frame)
     */
     ...
     * 
     * camera property, current camera screen exposure
     * (i.e. byte camera device supported frame)
     */
     ...
     * 
     * camera property, current camera preview shot id
     * (i.e. byte camera device supported frame)
     */
     ...
     * 
     * camera property, current camera support mode + countdown
     * (i.e. uint32[] camera device supported frame)
     */
     ...
     * 
     * camera property, current camera secure face mode
     * (i.e. uint32 camera device supported frame)
     */
     ...
     * ohos.control.secure [static, uint32[], ndk_public]
     * 
     * camera property, current camera secure facSe info
     * (i.e. uint32[] camera device supported frame)
     */
     ...
     * ohos.control.secure [static, uint32, ndk_public]
     * 
     * camera property, current camera face auth resuilt
     * (i.e. uint32 camera device supported frame)
     */
     ...
     * ohos.control.secure [static, uint32[], ndk_public]
     * 
     * camera property, current camera secure flash seq
     * (i.e. uint32[] camera device supported frame)
     */
     ...
     * 
     * camera property, current camera IR lens
     * (i.e. byte camera device supported frame)
     */
     ...
     * ohos.control.secure [static, byte, ndk_public]
     * 
     * camera property, current camera IR lens lockae
     * (i.e. byte camera device supported frame)
     */
     ...
     * 
     * camera property, current camera normal/bright/soft/mono
     * (i.e. byte camera device supported frame)
     */
